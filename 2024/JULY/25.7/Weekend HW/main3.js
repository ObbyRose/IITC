...
// let a= 5
// let b=5
// if (a==b) console.log("they are similar");
// let c = 8
// let d = 8
// if (c===d) console.log("they are similar");
...
//
// A:One checks for equality without type conversion, the other doesn't.
...
// let a=5
// let b=10
// if(a!==b) console.log("They're different");
...
// a:It compares two values in a specific way.
...
//a: It's the opposite of the > operator. and still compares two values in a specific way
...
// let a= 5
// let b = 3
// if (a>b) console.log(true) // it will indeed return true but 5 is indeed 5>3
//    [Learn more about comparison operators](https://www.w3schools.com/js/js_comparisons.asp)
...
// let a="10"
// a===10
// console.log(a) // the result would be an equal to 10
//    [Learn more about strict equality](https://www.w3schools.com/js/js_comparisons.asp)

// 10. What is the result of 7 <= 7?
//     Hint: Consider what "less than or equal to" means.

// the result would be true as it says less then or equal and it is indeed equal
...
//     Hint: Strings are compared character by character.
   ...
   //   let string1="apple"
   //   let string2="banana"
   //   if(string1>string2) console.log("they are not in alphabetical order");
   //   else console.log("They are in alphabetical order");
...
// the result would be true due because the value is not similar to a string
// console.log(5!=="5");
...
// 
// A: JavaScript variables can be converted to a new variable and another data type:
