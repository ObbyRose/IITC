...
//    Hint: It combines addition with assignment.
      ...
      // A:
      //It combines addition with assignment.
...
// A: It combines multiplication with assignment.
...
// A: It combines division with assignment
...
// A: They achieve the same result, but one is more concise.
...
//     Hint: Think about how strings can be combined.
      ...
      //  a+="raise"
      //  console.log(a);
      // All that would be done is the addition of the value or the string next to the original variable
...
//     Hint: First assign 5 to x, then add 3 to it.
      ...
      //  let x = 5
      //  x+=3
      //  console.log(x) // the answer would be 8
