...
app.patch = (desc) => {return desc}

app.delete = function() {return 'failed'};

app.checkPositive = (a) => {if(a>0){ return `the number is positive`} else return "the number is negative"}
